...
public class EntityStackerManager {
    ...
    private final Set<EntityType> entitiesToStack;
    private final ArrayList<LivingEntity> validEnity = new ArrayList<>();
    private final ArrayList<LivingEntity> entitiesToMultiplyOnDeath = new ArrayList<>();

    private final ArrayList<String> instantKillPlayers = new ArrayList<>();
